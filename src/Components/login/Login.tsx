...
function Login() {
    ...
    return (
        <div className={styles.card}>
            <input
                value=""
                className={styles.blindCheck}
                type="checkbox"
                id="blind-input"
                name="blindcheck"
                hidden
            />
            <label htmlFor="blind-input" className={styles.blindInput}>
            ...
            <label htmlFor="blind-input" className={styles.avatar}>
            <svg
...
display: flex;
  ...
  align-items: center;
  min-height: 100vh;
  //background-color:rgba(255, 195, 130, 0.59); // Opcional: un color de fondo suave
  ...
  .card {
    ...
    font-family: "Trebuchet MS", "Lucida Sans Unicode", "Lucida Grande",
      ...
      //box-shadow: 0 0 0 2px #FFC382;
      background: white;
  box-shadow: 0 10px 20px rgba(255, 195, 130, 0.2), 0 6px 6px rgba(255, 195, 130, 0.1);
  ...
  box-shadow: 0 15px 30px rgba(255, 195, 130, 0.3), 0 10px 10px rgba(255, 195, 130, 0.2);
}
